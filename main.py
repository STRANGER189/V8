...
TOKEN = '8034624971:AAF0IdrN4Ydep5SWdpBYdzUJsenvByC8-9Y'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [5870168842,-1002174778647,-1002331017006]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @Samahi18_09")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @Samahi18_09\n"
...
def show_id(message):
    ...
    bot_owner = "Samahi18_09"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @Samahi18_09")
...
This bot is owned and operated by @Samahi18_09 on Telegram and all4outgaming on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @Samahi18_09 on Telegram and Samahi18_09, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @Samahi18_09 on Telegram and all4outgaming on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @Samahi18_09 on Telegram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @Samahi18_09 Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
